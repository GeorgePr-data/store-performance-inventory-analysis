...
This project analyzes retail store performance with a focus on inventory efficiency and stock allocation decisions.

## Objective

Identify underperforming stores, detect inefficient inventory allocation, and highlight opportunities to improve stock utilization across locations.

## Key Insights

- A clear imbalance in sell-through across stores highlights an opportunity for stock redistribution from lower-performing locations to higher-demand stores.
- A category with consistently low sell-through and relatively high inventory indicates inefficient stock allocation and potential risk of overstock.
